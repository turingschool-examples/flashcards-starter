...
describe('Turn', function() {
  ...
  it.skip('should take in a guess and a card', function() {
    const card = new Card(1, 'What does the "R" stand for in Roy G. Biv?', ['red', 'rodeo', 'retro', 'razzle dazzle'], 'red');
  ...
  it.skip('should return the user\'s guess', function() {
    const card = new Card(2, 'What is the capitol of Minnesota?', ['Minneapolis', 'Duluth', 'St. Paul', 'Minnetonka'], 'St. Paul');
  ...
  it.skip('should return the card object', function() {
    const card = new Card(3, 'What is the best month of the year?', ['January', 'April', 'July', 'October'], 'October');
  ...
  it.skip('should determine whether the user\'s guess matches the correct answer on the card', function() {
    const card = new Card(4, 'Which ocean is the Bermuda Triangle located in?' ['Pacific Ocean', 'Atlantic Ocean', 'Indian Ocean', 'Arctic Ocean'], 'Atlantic Ocean');
  ...
  it.skip('should give feedback based on whether the guess was correct', function() {
    const card = new Card(5, 'Which country occupies half of South America\'s western coast?', ['Argentina', 'Brazil', 'Venezuela', 'Chile'], 'Chile');
