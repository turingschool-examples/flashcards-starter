...
describe('Round', () => {
    ...
    beforeEach(() => {
        ...
        card3 = new Card(3, "What type of prototype method directly modifies the existing array?", ["mutator method", "accessor method", "iteration method"],
            "mutator method")
    ...
    it('should provide feedback for a incorrect guess', () => {
        // :(
