...
describe('Round', () => {
  ...
  it(`should store the deck of flash cards currently being used`, function() {
    expect(round.currentDeck.deck.length).to.deep.equal(3);
  });

  it('should return the currentCard being played', function() {
  ...
  it('should store the id of incorrect answers', function() {
    round.takeTurn('Ron');
  ...
  it('should give appropriate feedback for correct/incorrect answer', function() {
    expect(round.takeTurn('Ron')).to.deep.equal('incorrect!');
    expect(round.takeTurn('6')).to.deep.equal('correct!');
  });

  it('should be able to calculate and return the percentage of correct answers', function() {
    round.takeTurn('Ron');
    round.takeTurn('6');
    round.takeTurn('Potions');
  ...
  it('should print a message declaring the round is over and declaring the final score', function() {
    round.takeTurn('Ron');
    round.takeTurn('6');
    round.takeTurn('Potions');
