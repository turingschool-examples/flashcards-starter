...
describe('Round', function() {
  ...
  it('should take a deck of cards', function() {
    ...
    expect(round.deck).to.deep.equal([{id: 1, question: 'What allows you to define a set of related information using key-value pairs?', answers: ['object', 'array', 'function'], correctAnswer: 'object'}, {id: 6, question: 'What is an example of a mutator method?', answers: ['sort()', 'map()', 'join()'], correctAnswer: 'sort()'}, {id: 13, question: 'The callback function for map() returns a modified version of the current element.', answers: ['true', 'false'], correctAnswer: 'true' }]);
    expect(round2.deck).to.deep.equal([{id: 13, question: 'The callback function for map() returns a modified version of the current element.', answers: ['true', 'false'], correctAnswer: 'true' }, {id: 6, question: 'What is an example of a mutator method?', answers: ['sort()', 'map()', 'join()'], correctAnswer: 'sort()'}, {id: 1, question: 'What allows you to define a set of related information using key-value pairs?', answers: ['object', 'array', 'function'], correctAnswer: 'object'}]);
  })
  ...
  it('should have the current card be the first in the deck', function() {
    ...
    expect(round2.currentCard).to.deep.equal({id:13, question: 'The callback function for map() returns a modified version of the current element.', answers: ['true', 'false'], correctAnswer: 'true'})
  })
  ...
  it('should return the current card', function() {
    ...
    expect(round2.returnCurrentCard()).to.deep.equal({id:13, question: 'The callback function for map() returns a modified version of the current element.', answers: ['true', 'false'], correctAnswer: 'true'})
  })
  ...
  it('should instantiate a new Turn with each guess', function() {
    const card1 = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object')
    const deck = new Deck([card1])
    const round = new Round(deck)

    var turn1 = round.takeTurn('object')
  ...
  it.skip('should rotate cards', function() {
    ...
    expect(round.currentCard).to.deep.equal({id: 6, question: 'What is an example of a mutator method?', answers: ['sort()', 'map()', 'join()'], correctAnswer: 'sort()'})
