...
describe('Turn', function() {
  ...
  it.skip('should take a users guess', function() {
  ...
  it.skip('should take a card', function() {
    ...
    expect(turn.card.correctAnswer).to.equal('objec')
  })
  ...
  it.skip('should return the card', function() {
    ...
    expect(turn2.returnCard()).to.equal({id: 2, question: 'What is a comma-separated list of related values?', answers: ['array', 'object', 'function'], correctAnswer: 'array'})
  })
  ...
  it.skip('should evaluate if the guess is true or false', function() {
      ...
      expect(turn3.evaulateGuess()).to.equal(true);
  })
  ...
  it.skip('should give feedback on all guesses', function() {
