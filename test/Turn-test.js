...
describe('Turn', function() {
  ...
  it('should return the card', function() {
    ...
    expect(turn2.returnCard()).to.deep.equal({id: 2, question: 'What is a comma-separated list of related values?', answers: ['array', 'object', 'function'], correctAnswer: 'array'})
  })
