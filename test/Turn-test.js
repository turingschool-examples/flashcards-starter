...
describe('Turn', function() {
  ...
  it.skip('should take a guess as a string', function() {
    const turn = new Turn('Blue');
    expect(turn.guess).to.equal('Blue');
  });

  it.skip('should take a card object for the current question', function() {
  ...
  it.skip('should be able to evaluate if the guess is correct', function() {
    const card = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object');
    const turn = new Turn('Blue', card);
    turn.evaluateGuess();
  ...
  it.skip('should be able to give feedback if the guess is correct or incorrect', function() {
    const card = new Card(1, 'What allows you to define a set of related information using key-value pairs?', ['object', 'array', 'function'], 'object');
    const turn = new Turn('Blue', card);
    turn.evaluateGuess();
