...
[[
  ...
  {
    "id": 1,
    "question": "What is not a feature of Mocha",
    "answers": ["It", "Assert", "Describe"],
    "correctAnswer": "Describe"
  },
  {
    "id": 2,
    "question": "Which of these assertions will not work when comparing {a: 'b'} and {a: 'b'}",
    "answers": [".eql", "equal", "deeply.equal"],
    "correctAnswer": "Describe"
  },
  {
    "id": 3,
    "question": "What are the three steps of TDD",
    "answers": ["Drink Beer, Write Test, Pass Test", "Red Green, Refactor", "Write Code, Test, Refactor"],
    "correctAnswer": "Describe"
  },
  {
    "id": 4,
    "question": "What is describe() used for",
    "answers": ["To group related tests together", "To describe an individual test", "To assert what you want to test"],
    "correctAnswer": "Describe"
  }
]]
